...
<body>
    ...
    <input type="hidden" id="loginNo" value="${loginNo}">
        ...
        <div class="title">
            ...
            <td><p style="float: right; font-size: 18px;">${b.enrollDate }</p></td>
            </tr>
        </div>
			...
			<div style="width: 300px;" display: inline;>
            	<c:choose>
            		...
            		<c:when test="${likeYn==0}">  
	                	<a href="like.bo?boardNo=${b.boardNo}"><button>추천</button></a>
	                </c:when>
						
            		<c:when test="${likeYn>0}">
            			<a href="likeDelete.bo?boardNo=${b.boardNo}"><button>취소</button></a>
            		</c:when>
	            </c:choose>
	            ${likeCount}
            </div>
