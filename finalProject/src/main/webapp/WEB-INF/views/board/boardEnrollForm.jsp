...
<body>
    ...
    <div class="wrap">
        <div>
            ...
            <div class="title_box">
                제목 &nbsp; <input type="text" style="width: 390px; border-radius: 10px;" name="title">
            </div>
	        <div id="writer_wrap">
        ...
        <div>
            <div class="text_wrap">
                <textarea class="text_area" name="content" id="" cols="30" rows="10" placeholder="Input some text."></textarea>
                <br><br>
